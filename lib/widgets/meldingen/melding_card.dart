  ...
  Widget build(BuildContext context) {
    return Stack(
      ...
      children: [
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      // Reserve space for close button if present
                      if (onClose != null) const SizedBox(width: 32),
                    ],
                  ),
        ...
        // Close button positioned outside the card to ensure visibility
        if (onClose != null)
          Positioned(
            top: 0,
            right: 8,
              ...
              child: Column(
                ...
                children: [
                  Row(
                    children: [
                      Expanded(
                        child: _CategoryBadge(category: melding.category),
                      ),
